...
## Where I will start my adventures 🧙‍♂️
...
My goal with blogging is to talk about stuff as I do stuff - like problems, solutions, cool stuff, etc.

In fact, the very first thing to blog about is this blog itself!
...
Now I know that if an element has its own "block formatting context", then the margin of children elements stay within the containing element and doesn't get processed/handled/"collapsed" externally (to the parent element) via "margin collapsing". 🙂
...
Peace!
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY2NjIzNjA0NSwxNDQ1MDc0NTIxLDgwNT
