...
You want to develop a **computer application** with **real-time computer-generated graphics and sounds** portraying a **virtual world** where **inputs** from a user **change the state** of the world.
...
But, here's the thing... You're a "go-getter" - an "action-oriented" kind of person (although, you don't know that about yourself yet), so you say, well, I'll learn as I "dig through the trenches" - let's just **GO**, let's just **DO IT**.
...
## Perhaps bring a shovel to the trenches
...
Oh, and, the reality is, video game development is simply not for beginners. There are simply too many different things to learn that you can't learn all at once.
...
- Find beauty and appreciation in every part of every subject you learn along the way. Computers are quite remarkable, complex machines. It's impressive that you can do anything with them at all.
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQzODc2MjYyMCw3MTk5MTQ2MjUsLTE4MD
IyNTg3OTEsLTY4MTU3ODEwXX0=
-->